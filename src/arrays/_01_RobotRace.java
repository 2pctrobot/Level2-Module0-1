...
public static void main(String[] args) {
	...
	while(machine[0].getY()>190||machine[1].getY()>190||machine[2].getY()>190||machine[3].getY()>190||machine[4].getY()>190) {
		...
		if(machine[2].getY()<=190) {
			JOptionPane.showMessageDialog(null, "Congrats V3! You won!");
			break;}
		if(machine[3].getY()<=190) {
			JOptionPane.showMessageDialog(null, "Congrats V4! You won!");
			break;}
		if(machine[4].getY()<=190) {
			JOptionPane.showMessageDialog(null, "Congrats V5! You won!");
			break;}
